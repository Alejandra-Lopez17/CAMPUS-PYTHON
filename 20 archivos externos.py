...
numeroBytes = fichero.write(
    "Acabo de cargarme todo el contenido del fichero.\n")
...
print(
    f"Tiempo medio bucle for: {(meanFor/samples)*(10**3)}ms. Tiempo medio bucle while: {(meanWhile/samples)*(10**3)}ms")
