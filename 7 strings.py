...
print("Forma cutre: ")
print("Has comprado " + str(cantidad) + " unidades. Cada unidad vale " +
      str(precio) + "€. En total son: " + str(cantidad*precio) + "€")

print("Forma avanzada: ")
formatString = "Has comprado {} unidades. Cada una vale {}€. En total son {}€".format(
    cantidad, precio, cantidad*precio)
print(formatString)

print("God mode: ")
print(
    f"Has comprado {cantidad} unidades. Cada una vale {precio}€. En total son {precio*cantidad}€")
