import os
import logging
#  10: Funciones - Capítulo dos: argumentos arbitrarios y keyword arguments
#
...
printKwargs(clase="mago", nombre="Thorofin", raza="Elfo",
            mascota="Dragón", nivel="165", clan="ValenciaFC")
...
pj = crearPersonaje("Dandelion", "ataque fuerte", "esquivar", "bomba de humo",
                    raza="Elfo", mascota="Dragón", nivel="165", clan="ValenciaFC")
print(pj)
