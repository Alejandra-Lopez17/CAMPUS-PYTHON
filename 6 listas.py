...
# Sublista con los elementos de las posiciones 0, 1 y 2. Posición 3 no incluída.
sublista2 = lista[:3]
# Sublista que empieza en la posición 2, hasta el final de la lista.
sublista3 = lista[2:]
...
"""El metodo POP, eliminar elementos mediante su posicion, puede eliminar y retornar el elemento que e eliminado.
El metodo REMOVE, nos sirve eliminar elementos mediante su valor."""
...
# La función pop si argumento elimina y devuelve el último elemento.
elem = frutas.pop()
...
# Se le puede pasar el índice del elemento a eliminar como argumento.
elem = frutas.pop(2)
print(f"El elemento {elem} ha sido eliminado de la lista de frutas")
print(frutas)

print("Eliminar un elemento de la lista por su valor: ")
# La función remove eliminar un elemento por su valor. También lo devuelve
...
for x in range(5):
    keyword = input(
        "Introduce una palabra clave. Si no quieres escribe 'fin': ")
    if keyword == "fin":
        break
    else:
