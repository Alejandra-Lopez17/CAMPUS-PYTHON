...
try:
    ...
    logging.exception(
        "El error cuando intentamos eliminar un elemento de una tupla es: ")

try:
    mitupla.append("Yandel")
except BaseException:
    logging.exception(
        "El error cuando intentamos añadir un elemento nuevo a una tupla es: ")

try:
    mitupla[3] = "Yandel"
except BaseException:
    logging.exception(
        "El error cuando intentamos modificar un elemento nuevo a una tupla es: ")
...
print("Artista 1: {}. Artista 2 {}. Artista 3: {}".format(
    artista1, artista2, artista3))

mitupla = ("BadBunny", "Anuel", "Daddy Yankee",
           "Myke Towers", "Farruko", "C.Tangana")
print("El valor de mitupla es: ")
print(mitupla)
print("Desempaquetar: ")
...
print(
    f"Primer artista: {primerArtista}. Segundo Artista {segundoArtista}. Varios artistas: ")
print(variosArtistas)


(primerArtista, *variosArtistas, ultimoArtista) = mitupla
print(
    f"Primer artista: {primerArtista}. Último Artista {ultimoArtista}. Varios artistas: ")
print(variosArtistas)
